...
namespace allin1.Controllers
{
    public class EmployeeController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("EmployeeId,Name,Adress,PhoneNumber,Email")] Employee employee)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("EmployeeId,Name,Adress,PhoneNumber,Email")] Employee employee)
        {
                        ...
                        if (file.Length > 0)
                        {
                            using (var stream = new FileStream(filePath, FileMode.Create))
                            {
                                ...
                                for(int i = 0; i < dt.Rows.Count; i++)
                                {
                                    ...
                                    emp.Name = dt.Rows[i][0].ToString();
                                    emp.Adress = dt.Rows[i][1].ToString();
                                    emp.PhoneNumber = dt.Rows[i][2].ToString();
                                    emp.Email = dt.Rows[i][3].ToString();
                                    emp.EmployeeId = Convert.ToInt16(dt.Rows[i][4].ToString());
                                    _context.Add(emp);
                                }
                                await _context.SaveChangesAsync();
                                return RedirectToAction(nameof(Index));
